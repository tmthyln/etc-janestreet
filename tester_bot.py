...
def bond_strategy(exchange):
    ...
    size = 50
    write_to_exchange(exchange, { "type": "add", "order_id": 10, "symbol": "BOND", "dir": "BUY", "price": 998, "size": size * 2 })
    write_to_exchange(exchange, { "type": "add", "order_id": 22, "symbol": "BOND", "dir": "SELL", "price": 1002, "size": size * 2 })
